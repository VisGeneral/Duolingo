...
const lessonTypes = [
  ...
  "learningLanguage": "ru",
  "smartTipsVersion": 2,
  "skillId": "a8fa9da1f42436d55973cc68716ec270",
...
if (isMainThread) {
        ...
        getLanguages().then(({ fromLanguage, learningLanguage }) => {
            ...
            const handleWorkerMessage = (message) => {
                ...
                if (completed === Number(process.env.LESSONS)) {
                    ...
                    // Update the currentLessonIndex for the next worker
    ...
    const { headers, fromLanguage, learningLanguage, lessonIndex } = workerData;
